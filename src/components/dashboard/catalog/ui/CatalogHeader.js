...
export default function CatalogHeader({ productCount, onOpenProductModal, searchTerm, setSearchTerm }) {
    return (
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <article className="flex items-center gap-4">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-primary/90 hover:bg-primary transition-colors duration-300 text-foreground px-6 py-3 rounded-md cursor-pointer whitespace-nowrap"
                >
